...
const productLinks = [
  ...
  { label: "Ground Spices", href: "/products#ground-spices" },
  { label: "Agri Commodities", href: "/products#agri-commodities" },
  { label: "Processed & Roasted", href: "/products#processed" },
];

/* TODO: Replace social hrefs with real handles once profiles are created */
const socialLinks = [
  {
    label: "LinkedIn",
    href: "#TODO_LINKEDIN",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              {/* SVG Icon Mark */}
              <div className="relative h-11 w-11 overflow-hidden rounded-xl ring-1 ring-[#B8934A]/30 flex items-center justify-center bg-[#0A1B15]">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs mb-6">
              Global agricultural commodities & spice exporter. Sourcing,
              roasting, sorting, packaging, and warehousing — all under one
              roof. Based in Indore, MP.
            </p>
            {/* Social links */}
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              {/* TODO: Replace href with actual PDF link once available */}
              <a
                href="#TODO_COMPANY_PROFILE_PDF"
                className="inline-flex items-center gap-2 text-xs text-[#B8934A] hover:text-[#C2A159] transition-colors font-medium"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                {/* TODO: Replace with real business email once confirmed */}
                <span className="text-sm text-white/60">info@vishnutraders.in</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#B8934A] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <span className="text-sm text-white/60">Mon – Sat: 9:00 AM – 7:00 PM</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40">
            © {new Date().getFullYear()} Vishnu Traders. All rights reserved. | Indore, Madhya Pradesh, India
          </p>
